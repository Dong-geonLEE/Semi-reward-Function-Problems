...
model.save(path='./trained_model/minigrid_lava_s5_5e5')

print("=================================================================================")
print('result - MiniGrid-LavaGapS5-v0')
for e in list_envs:
    env = gym.make(e)
    env = ImgObsWrapper(env)
...
env = gym.make('MiniGrid-LavaGapS6-v0')
env = ImgObsWrapper(env)
...
model.save(path='./trained_model/minigrid_lava_s6_5e5')

print("=================================================================================")
print('result - MiniGrid-LavaGapS6-v0')
for e in list_envs:
    env = gym.make(e)
    env = ImgObsWrapper(env)
...
model.save(path='./trained_model/minigrid_lava_s7_5e5')

print("=================================================================================")
print('result - MiniGrid-LavaGapS7-v0')
for e in list_envs:
    env = gym.make(e)
    env = ImgObsWrapper(env)
