...
model.save(path='./trained_model/minigrid_distshift1')

print("=================================================================================")
print('result - MiniGrid-DistShift1-v0')
for e in list_envs:
    env = gym.make(e)
    env = ImgObsWrapper(env)
...
env = gym.make('MiniGrid-DistShift2-v0')
env = ImgObsWrapper(env)
...
model.save(path='./trained_model/minigrid_distshift2')
