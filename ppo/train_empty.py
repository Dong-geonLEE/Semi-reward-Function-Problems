...
model.learn(5e4, progress_bar=True)

model.save(path='./trained_model/minigrid_empty_5x5')

print("=================================================================================")
print('result - MiniGrid-Empty-Random-5x5-v0')
for e in list_envs:
    env = gym.make(e)
    env = ImgObsWrapper(env)
...
model.save(path='./trained_model/minigrid_empty_6x6')

print("=================================================================================")
print('result - MiniGrid-Empty-Random-6x6-v0')
for e in list_envs:
    env = gym.make(e)
    env = ImgObsWrapper(env)
...
model.save(path='./trained_model/minigrid_empty_8x8')

print("=================================================================================")
print('result - MiniGrid-Empty-8x8-v0')
for e in list_envs:
    env = gym.make(e)
    env = ImgObsWrapper(env)
...
model.save(path='./trained_model/minigrid_empty_16x16')

print("=================================================================================")
print('result - MiniGrid-Empty-16x16-v0')
for e in list_envs:
    env = gym.make(e)
    env = ImgObsWrapper(env)
